...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (CharacterSelected.instance.playerInput.actions["MenuRT"].IsPressed() && CharacterSelected.instance.playerInput.actions["MenuLT"].IsPressed() && canUseMenu && !WelcomeText.displayingText)
        {
            canUseMenu = false;
